				...
				<div class="swiper swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image: url('assets/img/Raja_Ampat.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						<div id="logo">
							<a href="index.html">
								<img class="logo-default" src={{ asset('assets/images/logo@2x.png') }} alt="Canvas Logo">
								<img class="logo-dark" src= {{ asset('assets/images/logo-dark@2x.png') }} alt="Canvas Logo">
							</a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container one-page-menu" data-easing="easeInOutExpo" data-speed="1500">
								...
								<li class="menu-item"><a class="menu-link" href="/logout"
							...
							<div class="col-sm-6 col-lg-4">
								<div class="feature-box media-box text-center">
									<div class="fbox-media">
										<img class="rounded" src={{ asset('storage/foto/' . $item->foto) }} alt="">
									</div>
									<div class="fbox-content px-0">
										<h3>{{ $item->title}}</h3>
                                        <p class="subtitle text-muted">{{$item->location}}</p>
						...
						<div id="portfolio" class="portfolio row g-0 text-center">
							...
							<article class="portfolio-item col-lg-3 col-md-4 col-sm-6 col-12 pf-graphics pf-uielements">
								<div class="grid-inner">
									<div class="portfolio-image">
										<a href="#">
											<img src={{ asset('assets/images/portfolio/4/2.jpg') }} alt="Mac Sunglasses">
										</a>
										<div class="bg-overlay">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
										...
										<div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="portfolio-single-gallery.html"><img src={{ asset('assets/images/portfolio/4/2.jpg') }} alt="Morning Dew"></a></div>
													<div class="slide"><a href="portfolio-single-gallery.html"><img src={{ asset('assets/images/portfolio/4/1.jpg') }} alt="Morning Dew"></a></div>
												</div>
											</div>
										</div>
										<div class="bg-overlay" data-lightbox="gallery">
											<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
												<a href={{ asset('assets/images/portfolio/4/2.jpg') }} class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="gallery-item"><i class="uil uil-images"></i></a>
												<a href= {{ asset('assets/images/portfolio/full/4-1.jpg') }} class="d-none" data-lightbox="gallery-item"></a>
												<a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"><i class="uil uil-ellipsis-h"></i></a>
											</div>
											<div class="bg-overlay-bg dark" data-hover-animate="fadeIn"></div>
										</div>
